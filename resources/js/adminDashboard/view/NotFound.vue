<template>
    <div class="not-found">
        <div>
            <div class="not-found__unique1">404</div>
            <div class="not-found__unique2">
...
div.not-found > div > div.not-found__unique1 {
    --tw-text-opacity: 1;
...
div.not-found > div > div.not-found__unique2 {
    padding-left: var(--tw-size-8);
    padding-right: var(--tw-size-8);
}

div.not-found > div > div > h1 {
    font-size: var(--tw-font-size-5xl);
    line-height: var(--tw-line-height-none);
    font-weight: var(--tw-font-weight-bold);
...
div.not-found > div > div > p {
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-gray-400) / var(--tw-text-opacity));
    margin-bottom: var(--tw-size-10);
}

div.not-found > div > div > div > a {
...
div.not-found > div > div > div > a:hover {
    --tw-bg-opacity: 1;
    background-color: rgb(var(--tw-color-indigo-700) / var(--tw-bg-opacity));
}

div.not-found > div > div > div > a:focus {
    ...
    --tw-ring-opacity: 1;
    --tw-ring-color: rgb(var(--tw-color-indigo-500) / var(--tw-ring-opacity));
}
</style>

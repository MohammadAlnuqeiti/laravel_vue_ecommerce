...
div.my-alert > div > form > :not([hidden]) ~ :not([hidden]) {
    --tw-space-y-reverse: 0;
    margin-top: calc(var(--tw-size-6) * calc(1 - var(--tw-space-y-reverse)));
    margin-bottom: calc(var(--tw-size-6) * var(--tw-space-y-reverse));
}

div.my-alert > div > form > div > label {
    display: block;
...
div.my-alert > div > form > div > div.my-alert__unique3 {
    margin-top: var(--tw-size-2);
}

div.my-alert > div > form > div > div > input {
    display: block;
    width: 100%;
    border-radius: var(--tw-border-radius-md);
    border-width: 0px;
    padding-top: var(--tw-size-1_5);
    padding-bottom: var(--tw-size-1_5);
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-gray-900) / var(--tw-text-opacity));
    ...
    --tw-ring-inset: inset;
    --tw-ring-opacity: 1;
    --tw-ring-color: rgb(var(--tw-color-gray-300) / var(--tw-ring-opacity));
}

div.my-alert > div > form > div > div > input::-moz-placeholder {
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-gray-400) / var(--tw-text-opacity));
}

div.my-alert > div > form > div > div > input::placeholder {
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-gray-400) / var(--tw-text-opacity));
}

div.my-alert > div > form > div > div > input:focus {
    --tw-ring-offset-shadow: var(--tw-ring-inset) 0 0 0
        var(--tw-ring-offset-width) var(--tw-ring-offset-color);
    --tw-ring-shadow: var(--tw-ring-inset) 0 0 0
    ...
    --tw-ring-inset: inset;
    --tw-ring-opacity: 1;
    --tw-ring-color: rgb(var(--tw-color-indigo-600) / var(--tw-ring-opacity));
}
...
div.my-alert > div > form > div > div.my-alert__unique4 {
    display: flex;
    align-items: center;
    justify-content: space-between;
}

div.my-alert > div > form > div > div > label {
    display: block;
    font-size: var(--tw-font-size-sm);
    line-height: var(--tw-line-height-5);
    font-weight: var(--tw-font-weight-medium);
...
div.my-alert > div > form > div > div > div {
    font-size: var(--tw-font-size-sm);
    line-height: var(--tw-line-height-5);
}

div.my-alert > div > form > div > div > div > a {
    font-weight: var(--tw-font-weight-semibold);
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-indigo-600) / var(--tw-text-opacity));
}

div.my-alert > div > form > div > div > div > a:hover {
    --tw-text-opacity: 1;
    color: rgb(var(--tw-color-indigo-500) / var(--tw-text-opacity));
}

div.my-alert > div > form > div > div.my-alert__unique5 {
    margin-top: var(--tw-size-2);
}

div.my-alert > div > form > div > button {
    display: flex;
    width: 100%;
    justify-content: center;
    border-radius: var(--tw-border-radius-md);
...
div.my-alert > div > form > div > button:hover {
    --tw-bg-opacity: 1;
    background-color: rgb(37, 36, 36);
}

div.my-alert > div > form > div > button:focus-visible {
    outline-style: solid;
    outline-width: 2px;
    outline-offset: 2px;
    outline-color: rgb(var(--tw-color-indigo-600) / 1);
}
...
div.errorMsg {
  ...
  --tw-bg-opacity: 1;
  background-color: rgb(var(--tw-color-red-500) / var(--tw-bg-opacity));
  --tw-text-opacity: 1;
  color: rgb(var(--tw-color-white) / var(--tw-text-opacity));

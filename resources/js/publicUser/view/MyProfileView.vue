                ...
                <div class="col-xl-3 col-md-4">
                    ...
                    <div class="my-account-menu mt-6">
                        <ul class="nav account-menu-list flex-column">
                            ...
                            <li>
                                <a data-bs-toggle="pill" href="#pills-order"
                                    ><i class="fa fa-shopping-cart"></i>
                                    Order</a
                                >
                            </li>
                            <li>
                                <a data-bs-toggle="pill" href="#pills-download"
                                    ><i class="fa fa-cloud-download"></i>
                                    Download</a
                                >
                            </li>
                            <li>
                                <a data-bs-toggle="pill" href="#pills-payment"
                                    ><i class="fa fa-credit-card"></i> Payment
                                    Method</a
                                >
                            </li>
                            <li>
                                <a data-bs-toggle="pill" href="#pills-address"
                                    ><i class="fa fa-map-marker"></i> Address</a
                                >
                            </li>
                            <li>
                                <a data-bs-toggle="pill" href="#pills-account"
                    ...
                    <div class="tab-content my-account-tab mt-6">
                        ...
                        >
                            <div class="my-account-dashboard account-wrapper">
                                ...
                                <div class="welcome-dashboard">
                                    <p>
                                        Hello, <strong>Alex Tuntuni</strong> (If
                                ...
                                <p class="mt-25">
                                    ...
                                    check & view your recent orders, manage your
                                    shipping and billing addresses and edit your
                        ...
                        <div class="tab-pane fade" id="pills-order">
                            <div class="my-account-order account-wrapper">
                                ...
                                <div
                                    class="account-table text-center mt-30 table-responsive"
                                >
                                    <table class="table">
                                        <thead>
                                            <tr>

<template>
    ...
    <div class="section section-padding">
        <div class="container">
            ...
            <div class="checkout-info mt-30">
                <p class="info-header">
                    <i class="fa fa-exclamation-circle"></i> Returning customer?
                    ...
                    <div class="col-lg-5">
                        <div class="checkout-order">
                            ...
                            <div class="checkout-payment">
                                        ...
                                        <div class="single-payment">
                                            <div class="payment-radio radio">
                                                ...
                                                <label for="paypal"
                                                    ...
                                                    <img
                                                        class="payment"
                                                        src="../../../../public/assets/images/payment-2.png"
                                                        alt=""
                                                    />
                                                    <a href="#"
                                                        >What is PayPal?</a
                                ...
                                <div class="single-form">
                                    <a
                                        class="btn btn-primary btn-hover-dark d-block"
                                        href="#"
                                        >Place Order</a
                                    >
                                </div>

<template>
    ...
    <div
        ...
        style="background-image: url(assets/images/shop.png)"
    >
        <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product">
                                            <a href="#"
                                                ><img
                                                    src="../../../../public/assets/images/product/product-06.jpg"
                                                    alt="product"
                                            /></a>
                                            <div class="product-content">
                                                <h4 class="title">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product">
                                            <a href="#"
                                                ><img
                                                    src="../../../../public/assets/images/product/product-07.jpg"
                                                    alt="product"
                                            /></a>
                                            <div class="product-content">
                                                <h4 class="title">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="single-product">
                                            <a href="#"
                                                ><img
                                                    src="../../../../public/assets/images/product/product-13.jpg"
                                                    alt="product"
                                            /></a>
                                            <div class="product-content">
                                                <h4 class="title">
                                ...
                                <div class="single-product-02 product-list">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <p>
                                            ...
                                            Jacket. Part of the Kaval
                                            Collection. Regular fit is eased,
                                            but not sloppy, and perfect for any
                                            activity. Plain-woven jacket
                                            specifically constructed for freedom
                                            of movement.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="widget-checkbox widget-categories">
                                <ul class="checkbox-items">
                                    <li>
                                        ...
                                        <label for="checkbox1">
                                            <span></span>Office Chair</label
                                        >
                                    </li>
                                    <li>
                                        <input type="checkbox" id="checkbox2" />
                                        <label for="checkbox2">
                                            <span></span>Dining Chair</label
                                        >
                                    </li>
                                    <li>
                                        <input type="checkbox" id="checkbox3" />
                                        <label for="checkbox3">
                                            <span></span>Office Table</label
                                        >
                                    </li>
                                    <li>
                                        <input type="checkbox" id="checkbox4" />
                                        <label for="checkbox4">
                                            <span></span>Dining Table</label
                                        >
                                    </li>
                                    <li>
                                        <input type="checkbox" id="checkbox5" />
                                        <label for="checkbox5">
                                            <span></span>Bed Light</label
                                        >
                                    </li>
                                    <li>
                                        <input type="checkbox" id="checkbox6" />
                                        <label for="checkbox6">
                                            <span></span>Sofa Set</label
                                        >
                                    </li>
                                    <li>
                                ...
                                <ul class="checkbox-items">
                                    ...
                                    <li>
                                        ...
                                        <label for="checkbox15">
                                            <span class="color-gray-dark"></span
                                            >Light Black</label
                                        >
                                    </li>
                                    <li>
